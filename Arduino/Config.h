...
#define CONFIG_H_
  ...
  const int MOVEMENT_INTERRUPT_SPEED = 128; // Interrupt cycle in micro seconds
  ...
  const long MOVEMENT_INVERT_MOTOR_Z_DEFAULT = 1;
  ...
  const long MOVEMENT_MIN_SPD_X_DEFAULT = 300;
  const long MOVEMENT_MIN_SPD_Y_DEFAULT = 300;
  const long MOVEMENT_MIN_SPD_Z_DEFAULT = 300;

  // Speed used for homing and calibration
  const long MOVEMENT_HOME_SPEED_X_DEFAULT = 300;
  const long MOVEMENT_HOME_SPEED_Y_DEFAULT = 300;
  const long MOVEMENT_HOME_SPEED_Z_DEFAULT = 300;
